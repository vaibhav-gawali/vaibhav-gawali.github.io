...
description: "How Hermes AI (using GPT-5.4 Nano), Microsoft Copilot (GPT-5.6 Thinking) and browser evidence helped me add a theme-aware reading progress bar to my Jekyll Chirpy blog."
image:
